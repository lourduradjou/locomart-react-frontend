        ...
        <div className="relative w-full max-w-72 max-h-72 overflow-hidden rounded-lg bg-gray-100 shadow-md">
            ...
            <div className="mt-2 px-5 pb-5">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <a
                        href="/"
                        className="flex justify-center self-baseline items-center rounded-md bg-slate-900 px-3 py-2 ml-2 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="mr-2 h-4 w46"
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke="currentColor"
                            strokeWidth="2"
