      ...
      {isEditing ? (
        <div className="profile-form">
          ...
          <input
            ...
            placeholder="Address"
          />
          <button onClick={handleSave} className="profile-button full-width">Save Changes</button>
        </div>
      ) : (
        <div className="profile-info">
          ...
          <button onClick={() => setIsEditing(true)} className="profile-button full-width">Edit Profile</button>
        </div>
      )}
    </div>
  );
